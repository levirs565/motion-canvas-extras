...
export interface AnimatedTexProps extends ShapeProps {
  tex?: SignalValue<string>;
  renderProps?: SignalValue<OptionList>;
}

export class AnimatedTex extends Shape {
  ...
  private latexToGraphic(tex: string): MathJaxGraphic {
    ...
    if (AnimatedTex.graphicContentsPool[src]) return AnimatedTex.graphicContentsPool[src];
    ...
    AnimatedTex.graphicContentsPool[src] = graphic;
  ...
  private scaleFactor() {
    ...
    return charHeight / AnimatedTex.mathJaxCharacterWidth();
  }
